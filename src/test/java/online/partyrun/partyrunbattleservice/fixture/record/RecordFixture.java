...
public class RecordFixture {
    ...
    public static final GpsData GPSDATA_4 = GpsData.of(4, 4, 4, startTime.plusSeconds(4), startTime);
    public static final GpsDatas GPSDATAS_1 = new GpsDatas(List.of(GPSDATA_1, GPSDATA_2, GPSDATA_3));
    ...
    public static final Record RECORD_4 = new Record(GPSDATA_4, 4);
